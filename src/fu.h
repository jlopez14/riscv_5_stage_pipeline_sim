...
/* struct to handle multiple fixed-point types */
...
extern void init_operand(operand_t *);
extern void init_int_wb_reg(ex_mem_wb_t *);
extern void init_fp_wb_reg(ex_mem_wb_t *);
extern void init_id_ex_reg(id_ex_t *);
extern void init_if_id_reg(if_id_t *);
extern void init_int_stage(fu_int_stage_t *, int);
extern void init_fp_stage(fu_fp_stage_t *, int);

extern int fu_int_read(fu_int_t **, FILE *);
extern int fu_fp_read(fu_fp_t **, FILE *);

extern int issue_fu_fp(fu_fp_t *, int, int, int, int, operand_t, operand_t, unsigned int, int, int, int);
extern int issue_fu_int(fu_int_t *, int, int, int, int, operand_t, operand_t, unsigned int, int, int, int);

extern int advance_fu_int(fu_int_t *, ex_mem_wb_t *);
extern int advance_fu_fp(fu_fp_t *, ex_mem_wb_t *);
...
extern void printInstructions(int instr);
